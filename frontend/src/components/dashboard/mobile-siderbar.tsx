                                ...
                                {menuItems.map(menu => {
                                    ...
                                    return (
                                        <Link
                                            href={menu.href}
                                            key={menu.title}
                                            className={cn("flex items-center gap-3 px-3 py-2 text-sm rounded-md font-medium transition-colors duration-300 text-white", isActive ? "bg-brand-primary text-white" : "hover:bg-gray-600")}
                                        >
