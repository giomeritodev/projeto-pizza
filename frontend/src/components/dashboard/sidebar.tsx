...
import { ShoppingCart, Package, Tags, LogOut, CreditCard, FileText } from "lucide-react"
                ...
                {menuItems.map(menu => {
                    ...
                    return (
                        <Link
                            href={menu.href}
                            key={menu.title}
                            className={cn("flex items-center gap-3 px-3 py-2 text-sm rounded-md font-medium transition-colors duration-300", isActive ? "bg-brand-primary text-white" : "hover:bg-gray-600")}
                        >
